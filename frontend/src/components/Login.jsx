...
console.log(`Error in Login : ${error.message}`);
    ...
    <div className='flex justify-center items-center h-screen'>
      ...
      {flag&&<button className='font-extrabold border border-solid-blue-400 p-3 bg-zinc-400 hover:text-white hover:bg-zinc-600' onClick={handleSignin}>SignIn</button>}
